...
crate::natives::define_gas_parameters_for_natives!(GasParameters, "aptos_framework", [
    [.account.create_address.base, "account.create_address.base", 3 * MUL],
    [.account.create_signer.base, "account.create_signer.base", 3 * MUL],

    [.bls12381.base, "bls12381.base", 150 * MUL],

    [.bls12381.per_pubkey_deserialize, "bls12381.per_pubkey_deserialize", 109_0 * MUL],
    [.bls12381.per_pubkey_aggregate, "bls12381.per_pubkey_aggregate", 4_2 * MUL],
    [.bls12381.per_pubkey_subgroup_check, "bls12381.per_pubkey_subgroup_check", 370_0 * MUL],

    [.bls12381.per_sig_deserialize, "bls12381.per_sig_deserialize", 222_0 * MUL],
    [.bls12381.per_sig_aggregate, "bls12381.per_sig_aggregate", 11_650 * MUL],
    [.bls12381.per_sig_subgroup_check, "bls12381.per_sig_subgroup_check", 460_5 * MUL],

    [.bls12381.per_sig_verify, "bls12381.per_sig_verify", 8_485_0 * MUL],
    [.bls12381.per_pop_verify, "bls12381.per_pop_verify", 10_3_0 * MUL],

    [.bls12381.per_pairing, "bls12381.per_pairing", 4_013_0 * MUL],

    [.bls12381.per_msg_hashing, "bls12381.per_msg_hashing", 1_540_0 * MUL],
    [.bls12381.per_byte_hashing, "bls12381.per_byte_hashing", 50 * MUL],

    [.ed25519.base, "signature.base", 150 * MUL],
    [.ed25519.per_pubkey_deserialize, "signature.per_pubkey_deserialize", 38_0 * MUL],
    ...
    [.ed25519.per_sig_strict_verify, "signature.per_sig_strict_verify", 267_0 * MUL],
    ...
    [.secp256k1.ecdsa_recover, "secp256k1.ecdsa_recover", 1_610_0 * MUL],

    [.ristretto255.basepoint_mul, "ristretto255.basepoint_mul", 128_0 * MUL],
    [.ristretto255.basepoint_double_mul, "ristretto255.basepoint_double_mul", 440_0 * MUL],

    [.ristretto255.point_add, "ristretto255.point_add", 2_135 * MUL],
    [.ristretto255.point_compress, "ristretto255.point_compress", 40_0 * MUL],
    [.ristretto255.point_decompress, "ristretto255.point_decompress", 40_5 * MUL],
    [.ristretto255.point_equals, "ristretto255.point_equals", 2_3 * MUL],
    [.ristretto255.point_from_64_uniform_bytes, "ristretto255.point_from_64_uniform_bytes", 81_5 * MUL],
    [.ristretto255.point_identity, "ristretto255.point_identity", 150 * MUL],
    [.ristretto255.point_mul, "ristretto255.point_mul", 471_0 * MUL],
    ...
    [.ristretto255.scalar_invert, "ristretto255.scalar_invert", 110_0 * MUL],
    ...
    [.hash.sip_hash.base, "hash.sip_hash.base", 10 * MUL],
    [.hash.sip_hash.per_byte, "hash.sip_hash.per_byte", 20 * MUL],

    [.hash.keccak256.base, { 1.. => "hash.keccak256.base" }, 40 * MUL],
    [.hash.keccak256.per_byte, { 1.. => "hash.keccak256.per_byte" }, 45 * MUL],

    [.type_info.type_of.base, "type_info.type_of.base", 3 * MUL],
    // TODO(Gas): the on-chain name is wrong...
    [.type_info.type_of.per_byte_in_str, "type_info.type_of.per_abstract_memory_unit", 5 * MUL],
    [.type_info.type_name.base, "type_info.type_name.base", 3 * MUL],
    // TODO(Gas): the on-chain name is wrong...
    ...
    // Back-of-the-envelop approximation from SHA3-256's (40 base, 45 per-byte) costs
    [.hash.sha3_512.base, { 4.. => "hash.sha3_512.base" }, 4_5],
    [.hash.sha3_512.per_byte, { 4.. => "hash.sha3_512.per_byte" }, 50],
    // Using SHA2-256's cost
    [.hash.ripemd160.base, { 4.. => "hash.ripemd160.base" }, 30],
    ...
    [.util.from_bytes.base, "util.from_bytes.base", 3 * MUL],
    [.util.from_bytes.per_byte, "util.from_bytes.per_byte", 5 * MUL],

    [.transaction_context.get_script_hash.base, "transaction_context.get_script_hash.base", 2 * MUL],

    [.code.request_publish.base, "code.request_publish.base", 5 * MUL],
    ...
    [.event.write_to_event_store.base, "event.write_to_event_store.base", 5_0],
    // TODO(Gas): the on-chain name is wrong...
    [.event.write_to_event_store.per_abstract_value_unit, "event.write_to_event_store.per_abstract_memory_unit", 5_0],

    [.state_storage.get_usage.base_cost, "state_storage.get_usage.base", 5 * MUL],

    [.aggregator.add.base, "aggregator.add.base", 3 * MUL],
    [.aggregator.read.base, "aggregator.read.base", 3 * MUL],
    [.aggregator.sub.base, "aggregator.sub.base", 3 * MUL],
    [.aggregator.destroy.base, "aggregator.destroy.base", 5 * MUL],
    [.aggregator_factory.new_aggregator.base, "aggregator_factory.new_aggregator.base", 5 * MUL],
