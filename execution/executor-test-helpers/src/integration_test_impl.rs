...
pub fn test_execution_with_storage_impl() -> Arc<AptosDB> {
    ...
    let output1 = executor
        .execute_block((block1_id, block1.clone().into()), parent_block_id)
        .unwrap();
    ...
    let output2 = executor
        .execute_block((block2_id, block2.into()), epoch2_genesis_id)
        .unwrap();
    ...
    let output3 = executor
        .execute_block((block3_id, block3.clone().into()), epoch3_genesis_id)
        .unwrap();
