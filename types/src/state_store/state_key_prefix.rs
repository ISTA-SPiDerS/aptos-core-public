...
mod tests {
    ...
    fn test_state_key_prefix() {
        ...
        let key1 = StateKey::access_path(AccessPath::new_path(address1, b"state_key".to_vec(), false));
        let key2 = StateKey::access_path(AccessPath::new_path(address2, b"state_key".to_vec(), false));
